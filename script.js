...
const translations = {
    es: {
        ...
        'exp2-item2': 'Planificación y organización de los enfoces de test para las distintas etapas',
        'exp2-item3': 'Supervisión de la gestión de defectos y monitoreo de las ejecuciones',
        'exp2-item4': 'Algunas de las herramientas utilizadas incluyenSAP Focused Build, Tricentis Tosca y Tricentis Live Compare',
    ...
    en: {
        ...
        'exp2-item2': 'Planification of test approaches for each phase',
